...
"[project]/lib/api/daily-records.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function createDailyRecord(record) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('daily_records').insert([
        record
    ]).select().single();
    if (error) throw error;
    return data;
...
async function getDailyRecords(farmerId, limit = 30) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('daily_records').select('*').eq('farmer_id', farmerId).order('record_date', {
        ascending: false
    }).limit(limit);
    if (error) throw error;
    return data;
...
async function getLatestDailyRecord(farmerId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('daily_records').select('*').eq('farmer_id', farmerId).order('created_at', {
        ascending: false
    }).limit(1).single();
    if (error && error.code !== 'PGRST116') throw error;
    return data;
...
async function updateDailyRecord(id, updates) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('daily_records').update(updates).eq('id', id).select().single();
    if (error) throw error;
    return data;
}
async function deleteDailyRecord(id) {
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('daily_records').delete().eq('id', id);
    if (error) throw error;
}
...
async function getRecordsByDateRange(farmerId, startDate, endDate) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('daily_records').select('*').eq('farmer_id', farmerId).gte('record_date', startDate).lte('record_date', endDate).order('record_date', {
        ascending: true
    });
    if (error) throw error;
    return data;
...
"[project]/lib/api/health-logs.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function createHealthLog(log) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('health_logs').insert([
        log
    ]).select().single();
    if (error) throw error;
    return data;
...
async function getHealthLogs(farmerId, limit = 50) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('health_logs').select('*').eq('farmer_id', farmerId).order('record_date', {
        ascending: false
    }).limit(limit);
    if (error) throw error;
    return data;
...
async function updateHealthLog(id, updates) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('health_logs').update(updates).eq('id', id).select().single();
    if (error) throw error;
    return data;
}
async function deleteHealthLog(id) {
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('health_logs').delete().eq('id', id);
    if (error) throw error;
}
}),
"[project]/lib/api/expenses.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function createExpense(expense) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('expenses').insert([
        expense
    ]).select().single();
    if (error) throw error;
    return data;
...
async function getExpenses(farmerId, limit = 50) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('expenses').select('*').eq('farmer_id', farmerId).order('expense_date', {
        ascending: false
    }).limit(limit);
    if (error) throw error;
    return data;
...
async function updateExpense(id, updates) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('expenses').update(updates).eq('id', id).select().single();
    if (error) throw error;
    return data;
}
async function deleteExpense(id) {
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('expenses').delete().eq('id', id);
    if (error) throw error;
}
async function getExpensesByCategory(farmerId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('expenses').select('category, amount').eq('farmer_id', farmerId);
    if (error) throw error;
...
async function getTotalExpenses(farmerId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('expenses').select('amount').eq('farmer_id', farmerId);
    if (error) throw error;
    return data.reduce((sum, exp)=>sum + exp.amount, 0);
}
}),
"[project]/lib/api/batches.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function createBatch(batch) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('batches').insert([
        {
            ...batch,
...
async function getBatches(farmerId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('batches').select('*').eq('farmer_id', farmerId).order('acquired_date', {
        ascending: false
    });
    if (error) throw error;
    return data;
...
async function getBatchById(id) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('batches').select('*').eq('id', id).single();
    if (error) throw error;
    return data;
}
async function updateBatch(id, updates) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('batches').update(updates).eq('id', id).select().single();
    if (error) throw error;
    return data;
}
async function deleteBatch(id) {
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('batches').delete().eq('id', id);
    if (error) throw error;
}
...
"[project]/lib/api/inventory.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function createInventoryItem(item) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').insert([
        item
    ]).select().single();
    if (error) throw error;
    return data;
...
async function getInventory(farmerId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').select('*').eq('farmer_id', farmerId).order('item_name', {
        ascending: true
    });
    if (error) throw error;
    return data;
...
async function getInventoryItem(id) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').select('*').eq('id', id).single();
    if (error) throw error;
    return data;
}
async function updateInventoryItem(id, updates) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').update(updates).eq('id', id).select().single();
    if (error) throw error;
    return data;
}
async function deleteInventoryItem(id) {
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').delete().eq('id', id);
    if (error) throw error;
}
...
"[project]/hooks/useFarmData.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$daily$2d$records$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api/daily-records.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$health$2d$logs$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api/health-logs.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$expenses$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api/expenses.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$batches$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api/batches.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$inventory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api/inventory.ts [app-ssr] (ecmascript)");
;
;
;
;
...
function useFarmData(farmerId) {
    ...
    const refresh = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        try {
            const [records, healthLogs, expenses, batches, inventory, stats, totalExpenses] = await Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$daily$2d$records$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDailyRecords"])(farmerId),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$health$2d$logs$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getHealthLogs"])(farmerId),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$expenses$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getExpenses"])(farmerId),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$batches$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBatches"])(farmerId),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$inventory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getInventory"])(farmerId),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$daily$2d$records$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getFarmStats"])(farmerId),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$expenses$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTotalExpenses"])(farmerId)
            ]);
            setState({
                records,
                healthLogs,
    ...
    const addRecord = async (record)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$daily$2d$records$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createDailyRecord"])({
                ...record,
                farmer_id: farmerId
            });
            await refresh();
    ...
    const removeRecord = async (id)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$daily$2d$records$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteDailyRecord"])(id);
            await refresh();
            return {
                success: true
            };
    ...
    const addHealthLog = async (log)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$health$2d$logs$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createHealthLog"])({
                ...log,
                farmer_id: farmerId
            });
            await refresh();
    ...
    const removeHealthLog = async (id)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$health$2d$logs$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteHealthLog"])(id);
            await refresh();
            return {
                success: true
            };
    ...
    const addExpense = async (expense)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$expenses$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createExpense"])({
                ...expense,
                farmer_id: farmerId
            });
            await refresh();
    ...
    const removeExpense = async (id)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$expenses$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteExpense"])(id);
            await refresh();
            return {
                success: true
            };
    ...
    const addBatch = async (batch)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$batches$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createBatch"])({
                ...batch,
                farmer_id: farmerId
            });
            await refresh();
    ...
    const updateBatch = async (id, newCount)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$batches$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateBatchCount"])(id, newCount);
            await refresh();
            return {
                success: true
            };
    ...
    const removeBatch = async (id)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$batches$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteBatch"])(id);
            await refresh();
            return {
                success: true
            };
    ...
    const addInventoryItem = async (item)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$inventory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createInventoryItem"])({
                ...item,
                farmer_id: farmerId
            });
            await refresh();
    ...
    const updateInventory = async (id, quantity)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$inventory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateInventoryQuantity"])(id, quantity);
            await refresh();
            return {
                success: true
            };
    ...
    const removeInventoryItem = async (id)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$inventory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteInventoryItem"])(id);
            await refresh();
            return {
                success: true
            };
...
"[project]/lib/api/alerts.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function createAlert(alert) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('ai_alerts').insert([
        alert
    ]).select().single();
    if (error) throw error;
    return data;
...
async function getAlerts(farmerId, limit = 20) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('ai_alerts').select('*').eq('farmer_id', farmerId).order('created_at', {
        ascending: false
    }).limit(limit);
    if (error) throw error;
    return data;
...
async function getUnreadAlerts(farmerId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('ai_alerts').select('*').eq('farmer_id', farmerId).eq('is_read', false).order('created_at', {
        ascending: false
    });
    if (error) throw error;
    return data;
...
async function getUnreadAlertCount(farmerId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('ai_alerts').select('id', {
        count: 'exact'
...
async function markAlertAsRead(id) {
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('ai_alerts').update({
        is_read: true
    }).eq('id', id);
    if (error) throw error;
}
...
async function deleteAlert(id) {
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('ai_alerts').delete().eq('id', id);
    if (error) throw error;
}
}),
"[project]/hooks/useAI.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const genAI = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2f$generative$2d$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GoogleGenerativeAI"](("TURBOPACK compile-time value", "AIzaSyAtqxUIOUOVWadFqEgxx37mvV81gQUvykI") || '');
...
function useAI(farmerId) {
    ...
    const [alertCount, setAlertCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    const getAIAdvice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (question, records)=>{
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        setLoading(true);
        try {
    ...
    const generateProactiveAlerts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (farmerId)=>{
        try {
            const [records, healthLogs] = await Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$daily$2d$records$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDailyRecords"])(farmerId, 10),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$health$2d$logs$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getHealthLogs"])(farmerId, 5)
            ]);
            const trendAlerts = analyzeTrends(records);
            for (const alert of trendAlerts){
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$alerts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createAlert"])({
                    ...alert,
                    farmer_id: farmerId
                });
            }
            if (healthLogs.some((log)=>log.action.toLowerCase().includes('disease') || log.action.toLowerCase().includes('sick'))) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$alerts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createAlert"])(diseaseAlert);
            }
            return trendAlerts;
        } catch (err) {
    ...
    const fetchAlerts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        if (!farmerId) return [];
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$alerts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAlerts"])(farmerId);
    }, [
        farmerId
    ]);
    const fetchUnreadCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$alerts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUnreadAlertCount"])(farmerId);
    }, [
        farmerId
    ]);
    const markAsRead = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (alertId)=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$alerts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["markAlertAsRead"])(alertId);
        const count = await fetchUnreadCount();
        setAlertCount(count);
    }, [
        fetchUnreadCount
    ]);
    const markAllRead = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        if (!farmerId) return;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$alerts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["markAllAlertsAsRead"])(farmerId);
        setAlertCount(0);
    }, [
        farmerId
    ]);
    const checkAndGenerateAlerts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        if (!farmerId) return;
...
"[project]/components/forms/DailyLogForm.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DailyLogForm({ onSubmit, loading = false }) {
    const [feedBags, setFeedBags] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const [feedCost, setFeedCost] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const [mortality, setMortality] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const [production, setProduction] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
...
"[project]/components/dashboard/AIAlerts.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AIAlerts({ farmerId, fetchAlerts, onMarkRead, onMarkAllRead }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "space-y-3",
                children: displayedAlerts.map((alert)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                !alert.is_read && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            alerts.length > 3 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
"[project]/components/dashboard/AIConsultant.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFarmData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useFarmData.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAI$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useAI.ts [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$forms$2f$DailyLogForm$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/forms/DailyLogForm.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$dashboard$2f$AIAlerts$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/dashboard/AIAlerts.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$dashboard$2f$AIConsultant$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/dashboard/AIConsultant.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
;
function Dashboard() {
    const { user, loading: authLoading, logout, getStoredFarmerId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const { success, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useToast$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useToast"])();
    const farmerId = user?.id || getStoredFarmerId();
    const { records, stats, loading: dataLoading, addRecord, addHealthLog, refresh } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFarmData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useFarmData"])(farmerId);
    const { getAIAdvice, fetchAlerts, markAsRead, markAllRead, checkAndGenerateAlerts } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAI$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAI"])(farmerId);
    const [vaccineName, setVaccineName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    const [questionLoading, setQuestionLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!authLoading && !user) {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$dashboard$2f$AIAlerts$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AIAlerts"], {
                                farmerId: farmerId,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$forms$2f$DailyLogForm$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DailyLogForm"], {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$dashboard$2f$AIConsultant$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AIConsultant"], {
                                onAsk: handleAskAI,
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-4",
                                        children: records.length > 0 ? records.slice(0, 5).map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_079ay5x._.js.map