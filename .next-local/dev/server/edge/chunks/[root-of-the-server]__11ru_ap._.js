...
async function middleware(request) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createServerClient"])(("TURBOPACK compile-time value", "https://hnylgsfxcmngjocaflah.supabase.co"), ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhueWxnc2Z4Y21uZ2pvY2FmbGFoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzUxNDAxMjQsImV4cCI6MjA5MDcxNjEyNH0.lgC2DMAaxmfW5gRvvvhpC0kfrGRmKTAlCc0LG-330Og"), {
        cookies: {
            getAll () {
                return request.cookies.getAll();
            },
            setAll (cookiesToSet) {
                // IMPORTANT: Only set on the response, not request
    ...
    const isProtectedPage = path.startsWith('/dashboard') || path === '/setup-profile';
